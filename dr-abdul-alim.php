        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-1521 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Abdul Alim</h2>
              <h3 class="text-theme fs-xs">Associate Professor (CC)<br> Department of Oral & Maxillofacial Surgery</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Abdul Alim is a dedicated oral and maxillofacial surgeon currently serving as Associate Professor (CC) in the Department of Oral & Maxillofacial Surgery at MH Samorita Hospital & Medical College (Dental Unit). With strong clinical and academic credentials, he is known for managing complex facial trauma, oral surgical procedures and minor maxillofacial operations with great care and precision.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and later obtained his MS in Oral & Maxillofacial Surgery from Bangladesh Medical University (BMU). Dr. Alim combines surgical expertise with a compassionate approach, contributing significantly to patient care and dental surgical education.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>BDS.</li>
                        <li>MS (Oral & Maxillofacial Surgery).</li>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Tooth impaction and surgical extraction</li>
                        <li>Management of facial trauma and fractures</li>
                        <li>Oral cysts and tumor surgeries</li>
                        <li>TMJ disorders</li>
                        <li>Pre-prosthetic surgery</li>
                        <li>Minor oral surgical procedures</li>
                        <li>Intraoral and extraoral lesion management</li>
                        <li>Academic training in maxillofacial techniques</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>He completed his BDS from a reputed institution in Bangladesh and obtained his MS in Oral & Maxillofacial Surgery from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
