        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="#" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-54472</span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Jhumur Ghosh</h2>
              <h3 class="text-theme fs-xs">Associate Professor & Consultant <br> Department of Hepatology</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Jhumur Ghosh is a dedicated liver specialist with strong clinical expertise in hepatology and over 10 years of experience treating liver and gastrointestinal diseases. She is known for her accurate diagnosis and compassionate approach in managing chronic liver disease, hepatitis, fatty liver and other digestive disorders. Her academic training and commitment to patient care have earned her recognition in both hospital and community settings.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                She completed her MBBS from Chittagong Medical College, followed by MD in Hepatology from Bangaladesh Medical University (BMU). She currently serves as a Consultant in the Department of Hepatology at MH Samorita Hospital & Medical College.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Hepatology (Liver & Digestive Diseases)</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Chronic hepatitis B and C management</li>
                        <li>Fatty liver disease (NAFLD/NASH)</li>
                        <li>Liver cirrhosis and its complications</li>
                        <li>Jaundice and cholestatic disorders</li>
                        <li>Alcoholic liver disease</li>
                        <li>Liver abscess and infections</li>
                        <li>Gastroesophageal reflux & indigestion</li>
                        <li>Abdominal pain and bloating</li>
                        <li>Liver function assessment and monitoring</li>
                        <li>Liver screening & counseling for at-risk patients</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>MBBS from Chittagong Medical College, followed by MD in Hepatology from Bangaladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
