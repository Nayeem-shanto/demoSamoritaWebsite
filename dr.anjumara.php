        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-123478 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Anjuman Ara</h2>
              <h3 class="text-theme fs-xs">Assistant Registrar<br> Department of Gynaecology & Obstetrics</h3>
              <p class="fs-md text-title" style="text-align: justify;">
               Dr. Anjuman Ara is a dedicated and experienced Consultant in Obstetrics and Gynaecology with a strong commitment to women's health and wellness. With over a decade of hands-on clinical experience, she is known for her skilled approach to managing both routine and complex gynecological conditions, ensuring safe motherhood and reproductive care for women of all ages.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               She earned her MBBS degree from Mymensingh Medical College and went on to complete FCPS in Obstetrics and Gynaecology from the Bangladesh College of Physicians and Surgeons (BCPS). Currently, Dr. Anjuman Ara serves as a Consultant at MH Samorita Hospital & Medical College, where she provides expert medical and surgical care.
              </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        ...
                        <li>Menstrual disorders and hormonal issues</li>
                        <li>Family planning and contraceptive procedures</li>
                        <li>Infertility evaluation and treatment</li>
                        <li>Cesarean and normal deliveries</li>
                        <li>Management of gynecological infections</li>
                        <li>Uterine fibroids and ovarian cysts</li>
                        <li>Menopause counseling and support</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>MBBS degree from Mymensingh Medical College FCPS in Obstetrics and Gynaecology from the Bangladesh College of Physicians and Surgeons (BCPS).</td>
                  </tr>
                </tbody>
              </table>
              <form
