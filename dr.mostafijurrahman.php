    ...
    <div class="row gx-40">
      <div class="col-lg-5">
        <div
          ...
          <a href="https://verify.bmdc.org.bd/" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-34177 </span><i
              ...
              <tr>
                ...
                <td>
                  <ul class="member-info-list">
                    <li>Trained in Internal Medicine (RMCH, SSMCH, DMCH, BMU)</li>
                    <li>Cardiology (DMCH)</li>
                    <li>Chest Diseases (NIDCH)</li>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <ul class="member-info-list">
                    ...
                    <li>FCPS (Medicine) Appeared – Bangladesh College of Physicians & Surgeons (BCPS)
</li>
              </tr>
              <tr>
