          ...
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-30106 </span><i
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>MBBS from Mymensingh Medical College, DCH (Diploma in Child Health) from BSMMU, and FCPS (Paediatrics) from the Bangladesh College of Physicians and Surgeons (BCPS).</td>
                  </tr>
                </tbody>
              </table>
              <form
