        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-812 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Prof. Dr. Md. Anwar Yousuf</h2>
              <h3 class="text-theme fs-xs">Professor and Vice Principle<br> Department of Oral Pathology & Periodontology</h3>
              <p class="fs-md text-title" style="text-align: justify;">
               Dr. Md. Anwar Yousuf is a distinguished dental academic and clinician, currently serving as Professor and Vice Principal at MH Samorita Hospital & Medical College (Dental Unit), in the Department of Oral Pathology & Periodontology. With extensive experience in teaching, clinical care and research, Dr. Yousuf is widely recognized for his expertise in oral disease diagnosis and periodontal therapy. His academic leadership and research contributions have earned him a respected place in the field of dental education.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               He completed his BDS from a reputed institution in Bangladesh followed by FCPS in Oral & Maxillofacial Pathology from the Bangladesh College of Physicians and Surgeons (BCPS), MS in Periodontology from Bangladesh Medical University (BMU), and Ph.D. in a specialized area of dental science.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Oral Pathology & Periodontology</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>BDS.</li>
                        <li>FCPS (Oral & Maxillofacial Pathology).</li>
                        <li>MS (Periodontology)</li>
                        <li>Ph.D</li>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Diagnosis and management of oral diseases</li>
                        <li>Periodontal therapy and surgery</li>
                        <li>Oral cancer detection and biopsy</li>
                        <li>Advanced gum treatment and regenerative procedures</li>
                        <li>Dental pathology and histological interpretation</li>
                        <li>Clinical mentoring and research supervision</li>
                        <li>Dental curriculum development and administration</li>
                        <li>Academic leadership in dental education</li>
                      </ul>
                    </td>
                  </tr>
                  <tr style="text-align: justify;">
                    <th ><strong>Academic Qualification</strong></th>
                    <td>He completed his BDS from a reputed institution in Bangladesh followed by FCPS in Oral & Maxillofacial Pathology from BCPS, MS in Periodontology from Bangladesh Medical University (BMU) and Ph.D. in dental sciences.</td>
                  </tr>
                </tbody>
              </table>
              <form
