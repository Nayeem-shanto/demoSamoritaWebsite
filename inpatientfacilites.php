...
<main class="impatient-facilities-container">
    <section>
        <div>
        ...
        <div>
            <h3 class="title-of-all-heading">NEWSPAPERS & MAGAZINES</h3>
        ...
        <div>
            <h3 class="title-of-all-heading">CONCIERGE SERVICES</h3>
            <p>Caring for our guests' needs is part of our commitment. To meet this commitment, we offer the following concierge services:</p>

            <ul>
                <li>
                    <strong>Business Center:</strong>
                    <br>We do not have a dedicated business center right now. However, if requested, we can organize services for phone calls from your room on a nominal payment. Please contact the Nurse-in-Charge of your floor to avail these services between <strong>9:00 AM to 10:00 PM</strong> on all working days.
                </li>

                <li>
                    <strong>Religious & Spiritual Service:</strong>
                    <br>Religious and spiritual services can be organized on request. We have a prayer room for males. For females, please contact the Nurse-in-Charge for arrangements.
                </li>

                <li>
                    <strong>Interpreter Service:</strong>
                    <br>Facilities are available for interpreter service on request.
                </li>
            </ul>
