        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-1776 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Mohammod Khabir Uddin</h2>
              <h3 class="text-theme fs-xs">Associate Professor (CC)<br> Department of Prosthodontics</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Mohammod Khabir Uddin is a skilled prosthodontist with extensive experience in dental restoration and rehabilitation. Currently serving as Associate Professor (CC) in the Department of Prosthodontics at MH Samorita Hospital & Medical College (Dental Unit), he specializes in the restoration of oral function, aesthetics and comfort through advanced prosthodontic techniques.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and obtained his MS in Prosthodontics from Bangladesh Medical University (BMU). Dr. Khabir is actively involved in both undergraduate teaching and prosthetic dental care, helping patients regain confidence with high-quality dental prostheses.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        ...
                        <li>Crown and bridge restorations</li>
                        <li>Implant-supported prostheses</li>
                        <li>Full mouth rehabilitation</li>
                        <li>Cosmetic and aesthetic dentistry</li>
                        <li>Temporomandibular joint (TMJ) management</li>
                        <li>Occlusion and bite correction</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque modi ducimus explicabo, architecto quos, iure officia pariatur nostrum nulla laudantium est incidunt saepe fugit, beatae minus cumque quia. Culpa, laboriosam.</td>
                  </tr>
                </tbody>
              </table>
              <form
