        ...
        <div class="breadcumb-content">
          ...
          <div class="breadcumb-menu-wrap">
            ...
            <ul class="breadcumb-menu">
              ...
              <li class="active">Educate. Innovate. Heal</li>
            </ul>
          </div>
        </div>
      </div>
          ...
          <div class="col-lg-6 mb-40 mb-lg-0">
            <div class="vs-surface wow" data-wow-delay="0.3s">
              <div class="about-img3 position-relative">
                <img
                  src="assets/img/about/about-4-1.jpg"
                  alt="About Image"
                  class="w-100"
                />
                <a
              ...
              <div class="row">
                <div class="col-xl-10">
                  <h2 class="h1 mb-3">
                    ...
                    <span class="text-theme">extra care.</span>
                  </h2>
                </div>
                <div class="col-xl-10">
                  <p class="mb-4">
                    MH Samorita Hospital & Medical College, Dhaka 
                    started its journey in 2010 with the permission from 
                    the MOH&FW of Government of the People’s Republic 
                    of Bangladesh & Universities of Dhaka. <br> There is also a 500 bedded teaching hospital at
                    tached to MH Samorita Medical College. <br>This Hospital is a well-equipped hospital delivering 
                    both general and specialized services including ICU, 
                    Cath Lab, CT Scan, CCU,  NICU, HDU & Dialysis unit.
                  </p>
                </div>
              </div>
            ...
            <div class="row justify-content-center justify-content-lg-between">
              <div class="col-md-6 col-lg-auto mb-30">
                <div class="d-xl-flex text-center text-xl-start skill-box">
                  <span
                    class="ripple-icon hover-style2 align-self-start mb-20 mb-xl-0 mr-20"
                    ><i class="flaticon-discuss"></i
                  ></span>
                  <div class="media-body">
                    <h2 class="mt-n2 mb-0 text-theme">15+</h2>
                    <p
                      class="text-title fs-md fw-medium mt-1 mt-xl-0 mb-2 mb-xl-2"
                    >
                      Years Of Experience
                    </p>
                    <p class="fs-xs mb-0">
                      Incubate extensive scenarios without top-line quality
                      vectors. Authoritatively engage
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
            <div class="col-xl-6 mb-30 mb-xl-0">
              <div class="about-content">
                <span class="h3 text-theme sec-subtitle mb-2 mb-md-0"
                  >7 Star Care & Protection</span
                >
                  ...
                  <div class="col-sm-6 col-lg-5 col-xl-6">
                    <div class="d-flex mb-25">
                      ...
                      <div class="media-body">
                        ...
                        <p class="mb-0 fs-xs">
                          Professional web-readiness via ubiquitous human
                          capital.
                        </p>
                      </div>
                    </div>
            ...
            <div class="col-xl-6">
              <div
                class="vs-accordion accordion accordion-style2"
                id="vsaccordion"
              >
                  ...
                  >
                    <div class="accordion-body">
                      <p>
                        ...
                        whereas turnkey total linkage. whiteboard
                        multifunctional channels with interoperable value.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          <div class="col-xl-4 mb-30">
            <div class="team-card">
              ...
              <div class="team-body">
                <h3 class="h4 mb-0">
                  <a href="team-details.php" class="text-reset">David Smith</a>
                </h3>
                ...
                <div class="">
                  <p class="fs-xs team-info">
                    ...
                    ><a class="text-reset" href="tel:+592201520156"
                      >+592 2015 20156</a
                    >
                  </p>
                  <p class="fs-xs team-info">
                    <i class="fas fa-envelope text-theme"></i
                    ><a class="text-reset" href="mailto:info.example@mail.com"
                      >info.example@mail.com</a
                    >
                  </p>
                </div>
              </div>
          ...
          <div class="col-xl-4 mb-30">
            <div class="team-card">
              ...
              <div class="team-body">
                <h3 class="h4 mb-0">
                  <a href="team-details.php" class="text-reset">Vivi Marian</a>
                </h3>
          ...
          <div class="col-xl-4 mb-30">
            <div class="team-card">
              ...
              <div class="team-body">
                <h3 class="h4 mb-0">
                  <a href="team-details.php" class="text-reset"
                    >Farhan Moris</a
                  >
                </h3>
