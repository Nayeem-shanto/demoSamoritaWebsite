        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-1686 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Sultana Parveen</h2>
              <h3 class="text-theme fs-xs">Assistant Professor<br>Department of Pediatric Dentistry</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Sultana Parveen is a compassionate and experienced pediatric dentist currently serving as Assistant Professor in the Department of Pediatric Dentistry at MH Samorita Hospital & Medical College (Dental Unit). She specializes in providing comprehensive dental care for infants, children and adolescents, with a focus on preventive care, behavior management and treating dental issues unique to younger patients.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                She completed her BDS from a reputed institution in Bangladesh and later obtained her FCPS in Pediatric Dentistry from the Bangladesh College of Physicians and Surgeons (BCPS). Dr. Parveen is known for her gentle approach and ability to build trust with children, ensuring a positive dental experience for every young patient.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>BDS.</li>
                        <li>FCPS (Pediatric Dentistry).</li>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Pediatric dental checkups and cleanings</li>
                        <li>Dental care for children with special needs</li>
                        <li>Preventive treatments (fluoride, sealants)</li>
                        <li>Pulp therapy and space maintenance</li>
                        <li>Early orthodontic assessment</li>
                        <li>Behavior management in dentistry</li>
                        <li>Management of dental trauma in children</li>
                        <li>Oral hygiene education for parents and children</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>She completed her BDS from a reputed institution in Bangladesh and obtained her FCPS in Pediatric Dentistry from the Bangladesh College of Physicians and Surgeons (BCPS).</td>
                  </tr>
                </tbody>
              </table>
              <form
