        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-123733 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              ...
              <h3 class="text-theme fs-xs">Assistant Registar<br> Department of Paediatrics</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Musharrat Tasnim is a dedicated and compassionate physician working as an Assistant Registrar in the Department of Paediatrics at MH Samorita Hospital & Medical College. With a solid foundation in paediatric clinical care, she supports both inpatient and outpatient services and assists in academic and ward-based teaching. She is known for her empathetic interaction with children and families and for maintaining a disciplined approach to child health management.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                            <li>General paediatric assessment and follow-up</li>
                            <li>Fever, respiratory infections and diarrheal diseases</li>
                            <li>Growth monitoring and nutritional counselling</li>
                            <li>Neonatal care and screening</li>
                            <li>Immunization and health education for parents</li>
                            <li>Ward coordination and discharge planning</li>
                            <li>Support in emergency paediatric care</li>
                            <li>Assisting in academic rounds and clinical teaching</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>MBBS from a reputed medical college under the University of Dhaka, with postgraduate training in Paediatrics currently ongoing.</td>
                  </tr>
                </tbody>
              </table>
              <form
