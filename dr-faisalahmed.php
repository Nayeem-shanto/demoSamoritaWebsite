        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-8504 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Faisal Ahmed</h2>
              <h3 class="text-theme fs-xs">Medical Officer (Evening)<br> OPD Unit</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Faisal Ahmed is a dedicated dental practitioner working as a Medical Officer in the Evening OPD at MH Samorita Hospital & Medical College (Dental Unit). He provides essential outpatient dental care with a focus on prompt diagnosis and patient-centered treatment planning.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh. Dr. Faisal is appreciated for his commitment to accessible and efficient dental service delivery during evening hours.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Outpatient dental checkups</li>
                        <li>Diagnosis and treatment of common dental conditions</li>
                        <li>Emergency dental care</li>
                        <li>Oral hygiene counseling</li>
                        <li>Minor restorative procedures</li>
                        <li>Patient guidance and referral services</li>
