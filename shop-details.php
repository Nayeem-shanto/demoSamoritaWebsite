                    ...
                    <div class="col-lg-6 col-xl-6 align-self-center">
                        <div class="product-details mt-n1">
                            ...
                            <div class="vs-input-group">
                                <div class="mr-15 text-title mb-2">Size :</div>
                            ...
                            <div class="actions">
                                ...
                                <a href="cart.php" class="vs-btn style2">Add To Cart<i class="fas fa-chevron-right"></i></a>
                            </div>
                            <div class="product_meta">
                                <span>Product By: <span class="sku">Hueiler Inc.LTD</span></span>
                                <span>SKU: <span class="sku">529</span></span>
                                <span>Category: <a href="shop.php">Cleanup</a><a href="shop.php">Repire</a></span>
                                <span>Tag: <a href="shop.php"> trendy</a></span>
                            </div>
                        </div>
                    </div>
                </div>
