...
<!-- doctor card 1 start -->
  ...
  <div class="info-box-ten text-center"> <!-- center aligned content -->
    ...
    <div>
        <p class="designation">Professor (CC) <br> & Head <br> <span style="font-size: small;">Department of Cardiology</span> </p>
...
<!-- Doctor 2 start -->
  ...
  <div class="info-box-ten text-center"> <!-- center aligned content -->
    ...
    <div>
      <p class="designation">Associate Professor<br> <span style="font-size: small;">Department of Cardiology</span>  </p>
    <p class="designation"><span style="color:#07ccec;">Specialty :<br><br></span>Cynical Interventional Cardiology</p>
    <p class="designation"><span style="color:#07ccec;">Degrees : <br><br></span>MBBS, D-CARD, MD(Cardiology)</p>
    </div>
