        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B- 3284 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. S.H.M Saifullah</h2>
              <h3 class="text-theme fs-xs">Assistant Professor (CC)<br>Department of Dental Anatomy</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. S.H.M Saifullah is an academic-focused dental professional currently serving as Assistant Professor (CC) in the Department of Dental Anatomy at MH Samorita Hospital & Medical College (Dental Unit). With a strong foundation in oral biology and anatomical sciences, he is committed to teaching dental morphology and structure with precision and clarity.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and obtained his DDS with specialization in Dental Anatomy from Bangladesh Medical University (BMU). Dr. Saifullah is dedicated to fostering deep anatomical understanding among dental students and plays an integral role in their early clinical education.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Tooth morphology and identification</li>
                        <li>Oral histology and development</li>
                        <li>Dental occlusion and articulation</li>
                        <li>Craniofacial anatomy</li>
                        <li>Head and neck anatomy</li>
                        <li>Dental education and curriculum design</li>
                        <li>Academic mentoring and assessments</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>He completed his BDS from a reputed institution in Bangladesh and obtained his DDS in Dental Anatomy from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
