        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="#" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-14668 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              ...
              <h3 class="text-theme fs-xs">Principal<br> Head of Department <br>Department of Endocrinology </h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Prof. Dr. Md. Abdul Jalil Ansari is a senior endocrinologist with over 27 years of experience in treating complex hormonal and metabolic disorders. He is one of the most respected figures in Bangladesh’s endocrinology community and is widely known for his expertise in managing diabetes, thyroid disorders, obesity and hormonal imbalances. His leadership in both clinical practice and medical education has made a lasting impact on the field.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               He completed his MBBS from Rangpur Medical College, followed by MCPS in Medicine and MD in Endocrinology & Metabolism from Bangaladesh Medical University (BMU). He has held key academic positions in several major government medical colleges and currently serves as Professor & Head, Department of Endocrinology at Dhaka Medical College & Hospital. He also provides consultations at MH Samorita Hospital.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Medicine, Diabetes and Hormone Specialist</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>MBBS.</li>
                        <li>MCPS (Medicine).</li>
                        <li>MD (Endocrinology & Metabolism)</li>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                            ...
                            <li>Thyroid disorders (hypo/hyperthyroidism, nodules, goiter)</li>
                            <li>Obesity & metabolic syndrome</li>
                            <li>Adrenal & pituitary gland disorders</li>
                            <li>Hormonal imbalance in men & women</li>
                            <li>Osteoporosis & bone health</li>
                            <li>PCOS and menstrual irregularities</li>
                            <li>Growth and puberty disorders in adolescents</li>
                            <li>Lipid disorders (cholesterol, triglycerides)</li>
                  ...
                  <tr>
                    ...
                    <td>MBBS from Rangpur Medical College, followed by MCPS in Medicine and MD in Endocrinology & Metabolism from Bangaladesh Medical University (BMU).
                  </tr>
                </tbody>
              </table>
              <form
