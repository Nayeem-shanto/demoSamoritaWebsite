                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Haematology</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Family Physician</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Pediatrician</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Gynecologist</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Expert Surgeon</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="service-thumb">
                        ...
                        <div class="sr-body">
                            ...
                            <h3 class="h4 sr-title "><a class="text-reset" href="service-details.php">Nephrologist</a></h3>
                            <div class="sr-content">
                                <p class="sr-text">Appropriately customize excellent imperatives for products. </p>
                                <a href="service-details.php" class="link-btn">Read More<i class="fal fa-long-arrow-right"></i></a>
                            </div>
            ...
            <div class="row vs-carousel wow fadeIn" data-wow-delay="0.3s" data-arrows="true" data-slide-show="3" data-lg-slide-show="2">
                <div class="col-xl-4 mb-30">
                    <div class="team-card">
                        ...
                        <div class="team-body">
                            <h3 class="h4 mb-0"><a href="team-details.php" class="text-reset">David Smith</a></h3>
                ...
                <div class="col-xl-4 mb-30">
                    <div class="team-card">
                        ...
                        <div class="team-body">
                            <h3 class="h4 mb-0"><a href="team-details.php" class="text-reset">Vivi Marian</a></h3>
                ...
                <div class="col-xl-4 mb-30">
                    <div class="team-card">
                        ...
                        <div class="team-body">
                            <h3 class="h4 mb-0"><a href="team-details.php" class="text-reset">Farhan Moris</a></h3>
                ...
                <div class="col-xl-4 mb-30">
                    <div class="team-card">
                        ...
                        <div class="team-body">
                            <h3 class="h4 mb-0"><a href="team-details.php" class="text-reset">Jerzzy Lamot</a></h3>
