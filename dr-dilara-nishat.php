        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B- 4281 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Dilara Nishat</h2>
              <h3 class="text-theme fs-xs">Assistant Professor (CC)<br> Department of Dental Public Health</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Dilara Nishat is a dedicated academic and public health professional serving as Assistant Professor (CC) in the Department of Dental Public Health at MH Samorita Hospital & Medical College (Dental Unit). She focuses on preventive dentistry, oral health awareness and community-based dental programs.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                She completed her BDS from a reputed institution in Bangladesh and obtained her MPH in Dental Public Health from Bangladesh Medical University (BMU). Dr. Nishat is committed to promoting oral health equity through education, outreach and policy-oriented dental care.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                       <li>BDS.</li>
                       <li>MPH (Dental Public Health).</li>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Oral health promotion and education</li>
                        <li>Community dental outreach programs</li>
                        <li>Preventive and school dentistry</li>
                        <li>Epidemiology of oral diseases</li>
                        <li>Public health policy and planning</li>
                        <li>Research in dental public health</li>
                        <li>Fluoride use and caries prevention</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>She completed her BDS from a reputed institution in Bangladesh and obtained her MPH in Dental Public Health from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
