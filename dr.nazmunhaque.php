        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="#" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-22094 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              ...
              <h3 class="text-theme fs-xs">Registrar <br> Department of Transfusion Medicine</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Nazmun Haque is a dedicated physician working in the specialized field of Transfusion Medicine. As a Registrar, she plays a vital role in managing daily blood bank operations, donor screening, component separation and transfusion monitoring. Her attention to safety protocols and evidence-based transfusion practices ensures quality and reliability in lifesaving blood services.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               She completed her MBBS from a recognized government medical college and is currently pursuing her MD in Transfusion Medicine at Bangladesh Medical University (BMU). Dr. Haque currently serves as Registrar in the Department of Transfusion Medicine at MH Samorita Hospital & Medical College, contributing to both clinical transfusion support and academic coordination.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Transfusion Medicine & Blood Banking</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>MBBS.</li>
                        <li>MD (Transfusion Medicine- ongoing).</li>
                        <li>DBS & T</li>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Blood grouping, cross-matching and compatibility testing</li>
                        <li>Safe blood collection, storage and component separation</li>
                        <li>Screening for transfusion-transmissible infections (TTIs)</li>
                        <li>Donor counseling and selection</li>
                        <li>Platelet and plasma transfusion coordination</li>
                        <li>Hemovigilance and adverse transfusion reaction management</li>
                        <li>Collaboration with surgery, gynecology, oncology and ICU teams</li>
                        <li>Maintaining transfusion records and quality standards</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>MBBS from a recognized government medical college and is currently pursuing her MD in Transfusion Medicine at Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
