        ...
        <div class="row gx-40">
            <div class="col-lg-5">
                ...
                /> -->
                    ...
                    <a href="#" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-64945 </span><i
            ...
            <div class="col-lg-7">
                <div class="team-content">
                    <h2 class="mb-0 mt-n2">Asst. Prof. Dr. Tamanna Ahmed</h2>
                    <h3 class="text-theme fs-xs">MBBS, MS (Plastic Surgery) <br><br> Assistant Professor<br> Plastic Surgery Unit, Department of Surgery</h3>
                    <p class="fs-md text-title" style="text-align: justify;">
                        <strong>Asst. Prof. Dr. Tamanna Ahmed</strong> is a skilled plastic surgeon currently serving as Assistant Professor in the Plastic Surgery Unit, Department of Surgery at MH Samorita Hospital & Medical College. She is actively involved in both surgical practice and academic instruction. Dr. Tamanna is known for her precision in surgical procedures, dedication to patient care and commitment to training the next generation of surgeons. Her clinical expertise covers a wide range of plastic and reconstructive surgeries with emphasis on patient safety and post-operative recovery.
                    </p>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        ...
                                        <li>MS (Plastic Surgery) – National Institute of Burn & Plastic Surgery, BMU</li>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        ...
                                        <li>Hand surgery</li>
                                        <li>Congenital & Craniofacial surgery</li>
                                        <li>Emergency and trauma surgery</li>
                                        <li>Burn & Post-burn rehabilitation</li>
                                        <li>Trauma & Reconstruction</li>
                                        <li>Post-operative care and counseling</li>
                                        <li>Minor surgical interventions</li>
