        ...
        <div class="row gx-40">
            <div class="col-lg-5">
                ...
                <a href="#"><i class="fab fa-linkedin-in"></i></a> -->
                    ...
                    <a href="https://verify.bmdc.org.bd/" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-119834 </span>
            ...
            <div class="col-lg-7">
                <div class="team-content">
                    <h2 class="mb-0 mt-n2">Dr. S. M. Shabbir Hassan</h2>
                    <p class="text-theme fs-xs">MBBS<br><br>Assistant Registrar<br>Department of Surgery</p>
                    <div style="text-align: justify;">
                        <p class="fs-md text-title">
                            <strong>Dr. S. M. Shabbir Hassan</strong> is a dedicated general surgeon currently serving as Assistant Registrar in the Department of Surgery at MH Samorita Hospital & Medical College. He is involved in clinical evaluations, assisting in surgeries and providing post-operative care under the supervision of senior faculty. Dr. Hassan is appreciated for his attention to detail, teamwork and commitment to patient care. He regularly supports both emergency and elective surgical cases, contributing to the smooth functioning of the department.
                        </p>
                    </div>
                    <table class="member-table">
                        <tbody style="background-color: #f3f6f7;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        <li>General surgical assistance</li>
                                        <li>Pre and post-operative care</li>
                                        <li>Wound management and dressing</li>
                                        <li>Minor surgical procedures</li>
                                        <li>Abdominal and soft tissue conditions</li>
                                        <li>Patient monitoring and follow-up</li>
                                        <li>Surgical OPD support</li>
