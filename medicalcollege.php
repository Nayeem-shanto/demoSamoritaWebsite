...
<html class="no-js" lang="zxx">
  ...
  ============================== -->
    ...
    <section class="vs-hero-wrapper position-relative">
      ...
      >
        ...
        >
          ...
          >
            <a href="contact.php" class="vs-btn style7">Make Appointment</a>
          </div>
          <img
            width="703"
            height="709"
            ...
            <div class="feature-body">
              <div class="feature-content">
                <h3 class="feature-title">
                  <a href="servcie-details.php" class="text-inherit"
                    >Consultant</a
                  >
                </h3>
          ...
          >
            <div class="ps-xxl-5 pe-xxl-5">
              ...
              <h2 class="sec-title h1 mb-lg-4">
                Welcome to MH Samorita Medical COllege
              </h2>
        ...
        <div class="service-circle wow fadeInUp" data-wow-delay="0.4s">
          ...
          <div class="service-circle__center">
            ...
            <div class="service-circle__item">
              <h3 class="service-circle__title h4">
                <a href="service-details.php">Health patients comprehensive</a>
              </h3>
              <p class="service-circle__text">
            ...
            <div class="service-circle__item">
              <h3 class="service-circle__title h4">
                <a href="service-details.php">Pediatric Hematology Oncology</a>
              </h3>
              <p class="service-circle__text">
            ...
            <div class="service-circle__item">
              <h3 class="service-circle__title h4">
                <a href="service-details.php">Care Pediatric & Medicine </a>
              </h3>
              <p class="service-circle__text">
            ...
            <div class="service-circle__item">
              <h3 class="service-circle__title h4">
                <a href="service-details.php">Urogynecology & Pelvic Health</a>
              </h3>
              <p class="service-circle__text">
          ...
          <div class="col-auto">
            <div class="medical-box">
              ...
              <h3 class="medical-box__title">
                <a href="about.php" class="text-inherit"
      ...
      <div class="container">
        ...
        >
          <div class="col-xl-4 team-style1">
            <div class="team-img">
              <img src="assets/img/team/drmamun.jpg" alt="team" />
              <div class="team-shape"></div>
            </div>
            <div class="team-content">
              <h3 class="team-name">
                <a href="team-details.php" class="text-inherit">Prof. Dr. S. M. Mamun Iqbal</a>
              </h3>
              <span class="team-degi">Angiogram, angioplasty ( stenting), pacemaker, noninvasive
          ...
          <div class="col-xl-4 team-style1">
            ...
            <div class="team-content">
              <h3 class="team-name">
                <a href="#" class="text-inherit">Jakki Jamson</a>
              </h3>
              <span class="team-degi">Infectious disease</span>
              <div class="team-links">
                <a href="#"><i class="fab fa-facebook-f"></i></a>
                <a href="#"><i class="fab fa-twitter"></i></a>
                <a href="#"><i class="fab fa-google"></i></a>
          ...
          <div class="col-xl-4 team-style1">
            <div class="team-img">
              <img src="assets/img/team/team-5-3.png" alt="team" />
              <div class="team-shape"></div>
            </div>
            <div class="team-content">
              <h3 class="team-name">
                <a href="#" class="text-inherit">Noumina Morlee</a>
              </h3>
              <span class="team-degi">Dermatologists Expert</span>
              <div class="team-links">
                <a href="#"><i class="fab fa-facebook-f"></i></a>
                <a href="#"><i class="fab fa-twitter"></i></a>
                <a href="#"><i class="fab fa-google"></i></a>
          ...
          <div class="col-xl-4 team-style1">
            <div class="team-img">
              <img src="assets/img/team/team-5-4.png" alt="team" />
              <div class="team-shape"></div>
            </div>
            <div class="team-content">
              <h3 class="team-name">
                <a href="#" class="text-inherit">Jerzzy Lamot</a>
              </h3>
              <span class="team-degi">MBBS Specialist</span>
              <div class="team-links">
                <a href="#"><i class="fab fa-facebook-f"></i></a>
                <a href="#"><i class="fab fa-twitter"></i></a>
                <a href="#"><i class="fab fa-google"></i></a>
        ...
        <div class="event-inner">
          ...
          <div class="event-content">
            ...
            <h3 class="event-title">
              <a href="blog-details.php">Medico-legal conference 2023</a>
            </h3>
      ...
      <div>
        <div class="event-inner">
          ...
          <div class="event-content">
            ...
            >
            <h3 class="event-title">
              <a href="blog-details.php">Corona Virus Vassination 2023</a>
            </h3>
            <div class="event-counter">
    ...
    Blog Area
    ==============================-->
    <section class="vs-blog-wrapper space-md-bottom">
      <div class="container">
        <div
          class="section-title text-center wow fadeInUp"
          data-wow-delay="0.3s"
        >
          <h2 class="sec-title h1">
            Recent <span class="inner-text">Articles</span>
          </h2>
          <p class="sec-text">
            Search or browse by hospital, treatment or consultant to see what
            can do for you
        ...
        >
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img">
                <img src="assets/img/blog/blog-5-1.jpg" alt="blogthumb" />
              </div>
              <div class="blog-content">
                <a href="blog.php" class="blog-date">Augest 02, 2023</a>
                <h3 class="blog-title h4">
                  <a href="blog-details.php"
                    >The Lancet Gastroenterology & Hepatology</a
                  >
                </h3>
                <div class="blog-bottom">
                  <div class="blog-avater">
                    <img src="assets/img/blog/auth-5-1.jpg" alt="author" />
                  </div>
                  <p class="blog-auth-name">
                    by<a href="blog.php" class="text-inherit"
                      >willimes walqar</a
                    >
                  </p>
                </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img">
                <img src="assets/img/blog/blog-5-2.jpg" alt="blogthumb" />
              </div>
              <div class="blog-content">
                <a href="blog.php" class="blog-date">July 05, 2023</a>
                <h3 class="blog-title h4">
                  <a href="blog-details.php"
                    >Autonomous cell imaging with WiScan Hermes</a
                  >
                </h3>
                <div class="blog-bottom">
                  <div class="blog-avater">
                    <img src="assets/img/blog/auth-5-2.jpg" alt="author" />
                  </div>
                  <p class="blog-auth-name">
                    by<a href="blog.php" class="text-inherit">Polio lamot</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img">
                <img src="assets/img/blog/blog-5-3.jpg" alt="blogthumb" />
              </div>
              <div class="blog-content">
                <a href="blog.php" class="blog-date">March 08, 2023</a>
                <h3 class="blog-title h4">
                  <a href="blog-details.php"
                    >Superior image analysis with WiSoft Athena</a
                  >
                </h3>
                <div class="blog-bottom">
                  <div class="blog-avater">
                    <img src="assets/img/blog/auth-5-3.jpg" alt="author" />
                  </div>
                  <p class="blog-auth-name">
                    by<a href="blog.php" class="text-inherit">Peter Parker</a>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="col-xl-4">
            <div class="vs-blog blog-style1">
              <div class="blog-img">
                <img src="assets/img/blog/blog-5-4.jpg" alt="blogthumb" />
              </div>
              <div class="blog-content">
                <a href="blog.php" class="blog-date">December 13, 2023</a>
                <h3 class="blog-title h4">
                  <a href="blog-details.php"
                ...
                <div class="blog-bottom">
                  <div class="blog-avater">
                    <img src="assets/img/blog/auth-5-4.jpg" alt="author" />
                  </div>
                  <p class="blog-auth-name">
                    by<a href="blog.php" class="text-inherit">vivi Marian</a>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="sec-bottom-btn">
          <a href="blog.php" class="vs-btn style7">View All News</a>
        </div>
      </div>
    </section>
    <!--==============================
...
>
  ...
  <!-- Mirrored from html.vecurosoft.com/medixi/demo/index-4.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 09:14:16 GMT -->
</html>
