        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B - 8602 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Sudipta Biswas Tuli</h2>
              <h3 class="text-theme fs-xs">Assistant Professor (CC)<br> Department of Science of Dental Materials</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Sudipta Biswas Tuli is an accomplished dental academic currently serving as Assistant Professor (CC) in the Department of Science of Dental Materials at MH Samorita Hospital & Medical College (Dental Unit). Her work focuses on teaching the physical, chemical and biological properties of dental materials used in clinical practice and research.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                She completed her BDS from a reputed institution in Bangladesh and obtained her DDS in Science of Dental Materials from Bangladesh Medical University (BMU). Dr. Tuli is passionate about enhancing student understanding of biomaterials and their application in modern dentistry.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Science of Dental Materials</td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>BDS.</li>
                        <li>DDS (Science of Dental Materials).</li>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Properties of restorative and prosthetic materials</li>
                        <li>Selection and manipulation of dental materials</li>
                        <li>Biocompatibility and safety evaluation</li>
                        <li>Clinical application of dental cements and composites</li>
                        <li>Research in dental biomaterials</li>
                        <li>Student training in material science</li>
                        <li>Material failure analysis and prevention</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>She completed her BDS from a reputed institution in Bangladesh and obtained her DDS in Science of Dental Materials from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
