        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >             
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B- 8201 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Abu Talha Md Mahi Uddin</h2>
              ...
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Abu Talha Md Mahi Uddin is an academic-focused dental professional currently serving as Assistant Professor (CC) in the Department of Dental Anatomy at MH Samorita Hospital & Medical College (Dental Unit). He is passionate about dental morphology and foundational anatomical sciences essential for clinical dentistry.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and obtained his MS in Dental Anatomy from Bangladesh Medical University (BMU). Dr. Mahi Uddin is dedicated to student development and provides in-depth instruction on craniofacial structures and dental identification.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Tooth morphology and function</li>
                        <li>Head and neck anatomy</li>
                        <li>Dental occlusion and alignment</li>
                        <li>Oral histology and development</li>
                        <li>Craniofacial structure analysis</li>
                        <li>Dental education and academic mentoring</li>
                        <li>Preclinical training for dental students</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>He completed his BDS from a reputed institution in Bangladesh and obtained his MS in Dental Anatomy from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
