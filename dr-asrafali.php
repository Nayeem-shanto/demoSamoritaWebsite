        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-5483 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Asraf Ali Bissash</h2>
              <h3 class="text-theme fs-xs">Assistant Professor (CC)<br> Department of Oral Surgery</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Asraf Ali Bissash is a skilled oral and maxillofacial surgeon currently serving as Assistant Professor (CC) in the Department of Oral Surgery at MH Samorita Hospital & Medical College (Dental Unit). With a strong background in surgical procedures and clinical training, he is dedicated to the management of oral pathologies and surgical interventions.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and obtained his MDS in Oral Surgery from Bangladesh Medical University (BMU). Dr. Bissash is known for his precision in surgical techniques and his commitment to patient safety and education.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                    ...
                    <td>
                      <ul class="member-info-list">
                       <li>Minor oral surgical procedures</li>
                        <li>Tooth extractions and impacted teeth</li>
                        <li>Management of oral infections and cysts</li>
                        <li>Surgical removal of oral tumors</li>
                        <li>Pre-prosthetic surgery</li>
                        <li>Local anesthesia and pain control</li>
                        <li>Clinical instruction and supervision</li>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td>He completed his BDS from a reputed institution in Bangladesh and obtained his MDS in Oral Surgery from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
