        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-80946 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Shayma Hamid </h2>
              ...
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Shayma Hamid is a dedicated and detail-oriented specialist in Transfusion Medicine, with expertise in managing blood transfusion services, immunohematology and blood banking. With several years of clinical and laboratory experience, she ensures safe, compatible and effective transfusion practices for a wide range of medical and surgical patients.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               She completed her MBBS from a reputed government medical college and then pursued an MD in Transfusion Medicine from Bangladesh Medical University (BMU). Currently, she is working as a Consultant in the Department of Transfusion Medicine at MH Samorita Hospital & Medical College, where she oversees blood safety, donor screening and transfusion-related decision-making for inpatients and emergency services.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        ...
                        <li>MD.</li>
                        <li>DBS & T</li>
                        <li>MCPS (Transfusion Medicine)</li>
                  </tr>
                  <tr>
                    <th><strong>Areas of Expertise</strong></th>
                    <td>
                      <ul class="member-info-list">
                            <li>Safe blood transfusion practices</li>
                            <li>Blood grouping & cross-matching</li>
                            <li>Apheresis and component therapy</li>
                            <li>Management of transfusion reactions</li>
                            <li>Hemovigilance and quality control</li>
                            <li>Donor screening and selection</li>
                            <li>Rh and ABO incompatibility management</li>
                            <li>Platelet and plasma transfusion</li>
                            <li>Transfusion support in surgery, obstetrics, oncology and critical care</li>
                  ...
                  <tr>
                    ...
                    <td>MBBS from a reputed government medical college and then pursued an MD in Transfusion Medicine from Bangladesh Medical University (BMU).
                  </tr>
                </tbody>
              </table>
              <form
