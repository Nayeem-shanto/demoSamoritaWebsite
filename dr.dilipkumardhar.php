        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-9528 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              ...
              <h3 class="text-theme fs-xs">MBBS, FCPS (Medicine) <br><br>Professor, Department of Medicine <br> Ex-Principal, MH Samorita Hospital & Medical College, Dhaka  <br>& Sir Salimullah Medical College Mitford Hospital, Dhaka</h3>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                            ...
                            <li>Hypertension & cardiovascular disease</li>
                            <li>Respiratory disorders (asthma, COPD, pneumonia)</li>
                            <li>Gastrointestinal & liver conditions</li>
                            <li>Kidney disease & electrolyte imbalance</li>
                            <li>Neurological conditions (stroke, seizures)</li>
                            <li>Rheumatologic & autoimmune diseases</li>
                            <li>Infectious diseases (tuberculosis, dengue, typhoid)</li>
                            <li>Geriatric medicine & chronic care</li>
                            <li>Preventive medicine & lifestyle counseling</li>
