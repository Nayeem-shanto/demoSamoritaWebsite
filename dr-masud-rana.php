        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: B-2476 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Md. Masud Rana</h2>
              <h3 class="text-theme fs-xs">Associate Professor<br> Department of Orthodontics</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Md. Masud Rana is an experienced and highly skilled orthodontist currently serving as Associate Professor in the Department of Orthodontics at MH Samorita Hospital & Medical College (Dental Unit). Known for his precision and patient-friendly approach, he specializes in diagnosing and correcting dental and facial irregularities through advanced orthodontic techniques.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
                He completed his BDS from a reputed institution in Bangladesh and later obtained his FCPS in Orthodontics from the Bangladesh College of Physicians and Surgeons (BCPS). With extensive experience in clinical orthodontics and academic teaching, Dr. Rana plays a vital role in shaping the next generation of dental professionals.
              </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>BDS.</li>
                        <li>FCPS (Orthodontics).</li>                     
                  </tr>
                  <tr>
                    <th><strong>Areas of Expertise</strong></th>
                    <td>
                      <ul class="member-info-list">
                        <li>Braces and aligner treatment</li>
                        <li>Malocclusion correction</li>
                        <li>Jaw and bite alignment</li>
                        <li>Dental and facial aesthetics</li>
                        <li>Retainers and space maintainers</li>
                        <li>Orthodontic management of cleft cases</li>
                        <li>Growth modification therapy</li>
                        <li>Orthodontic teaching and training</li>                       
                      </ul>
                    </td>
                  </tr>
                  <tr style="text-align: justify;">
                    <th><strong>Academic Qualification</strong></th>
                    <td>He completed his BDS from a reputed institution in Bangladesh and obtained his FCPS in Orthodontics from the Bangladesh College of Physicians and Surgeons (BCPS).</td>
                  </tr>
                </tbody>
              </table>
              <form
