...
<!-- Mirrored from html.vecurosoft.com/medixi/demo/index-7.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 09:18:57 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>MH Samorita Medical College</title>
    <meta name="author" content="Vecuro">
    <meta name="description" content="MH Samorita Medical College and Hospital">
    <meta name="keywords" content="MH Samorita Medical College and Hospital">
...
<body class="">
  ...
  <![endif]-->
	...
	******************************** -->
                ...
                <ul>
                    <li class="menu-item-has-children">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="index-6.php">Home Six <span class="new-label">New</span></a></li>
                            <li><a href="index-7.php">Home Seven <span class="new-label">New</span></a></li>
                            <li><a href="index-8.php">Home Eight <span class="new-label">New</span></a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li class="menu-item-has-children">
                        <a href="#">Pages</a>
                        <ul class="sub-menu">
                            <li><a href="shop.php">Our Shop <span class="new-label">New</span></a></li>
                            <li><a href="shop-details.php">Shop Details <span class="new-label">New</span></a></li>
                            <li><a href="cart.php">Shopping Cart <span class="new-label">New</span></a></li>
                            <li><a href="checkout.php">Checkout <span class="new-label">New</span></a></li>
                            ...
                            <div class="col d-lg-flex justify-content-end">
                                <div class="location-box-two one">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h6 class="title"><a href="#">02-8878080</a></h6>
                                    </div>
                                </div>
                                <div class="location-box-two one">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h6 class="title"><a href="#">info@samorita.edu.bd</a></h6>
                                    </div>
                                </div>
                                <div class="location-box-two">
                                    ...
                                    <div class="content-box">
                                        ...
                                        <h6 class="title">117 Love Rd
                                            ,Tejgaon, Dhaka 1208, Bangladesh</h6>
                                    </div>                             
                                </div>
                                <a href="index-4.php" class="vs-btn style2">Hospital</a>
                    ...
                    <div class="container-style7">
                        <div class="outer-box">
                                        ...
                                        <li class="">
                                          ...
                                          <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                              ...
                                              <li><a href="#">Nursing</a>
                                              <ul class="sub-menu">
                                                <li><a href="#">BSC in Basic Nursing</a></li>
                                                <li><a href="#">BSC in  Post Basic Nursing</a></li>
                                                <li><a href="#">Post Basic BSC</a></li>
                                              </ul>
                                              </li>
                                            </ul>
                                          </li>
                                          <li>
                                            ...
                                            <ul class="sub-menu">
                                              ...
                                              <li><a href="#">Application of Procedure</a></li>
                                          ...
                                          <li>
                                            ...
                                            <ul class="sub-menu">
                                              <li><a href="#">Clinical</a>
                                                <ul class="sub-menu">
                                                  <li><a href="gynecologyandobstetrics.php">Gynecology & Obstetrics</a></li>
                                                  <li><a href="#">General Surgery</a></li>
                                                  <li><a href="#">Cardiology & CCU</a></li>
                                                  <li><a href="#">ENT & Head Neck Surgery</a></li>
                                                  <li><a href="#">Orthopedics Surgery</a></li>
                            ...
                            <!-- <div class="social-box">
                                <a href="#" class="icon-btn-three style3 searchBoxTggler"><i class="far fa-search"></i></a>
                                ...
                                <!-- <div class="btn-box-seven">
                                    <a href="#" class="btn-style7 v1">Appointments</a>
                                </div> -->
                            </div>
                        </div>
                    </div>
        ...
        <div class="banner-slide-eight">
            <div class="banner-slide">
                <div class="banner-content">
                    <img src="assets/img/hero/h-bg-1-2.jpg" alt="">
                    <div class="banner-text">
                        <div class="container-style8">
                            <div class="banner-sec-info one-time">
                                <h1 class="animated" data-animation-in="fadeInUp" data-delay-in="0.1">Extraordinary Care <br>is Right Here</h1>
                                <p class="animated" data-animation-in="fadeInUp" data-delay-in="0.3">As well as providing face-to-face consultations with doctors,<br> we offer a growing number of online services</p>
                                <a href="#" class="btn-style8 v8" title="" data-animation-in="fadeInUp" data-delay-in="0.5">Discover Services</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-0">
                <div class="col-lg-5 col-md-112 col-sm-12">
                    <div class="service-img-eight">
                        <a href="service-details.php" class="ext-box"></a>
                        <img src="assets/img/service/ser8-1.jpg" alt="">
                        <div class="service-content-eight">
                            <h6 class="title">Medical Advices &<br> Checkup</h6>
                            <p>Continually evisculate goal-oriented portals<br> rather than prospective channels.</p>
                        </div>
                        <div class="ser-icon-box v1">
                            <img src="assets/img/service/ser-icon8-1.svg" alt="">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="service-img-eight-v1">
                                ...
                                <div class="service-content-eight-v1">
                                    <h6 class="title">Cardiovascular<br> for Women’s</h6>
                                </div>
                                <div class="ser-icons-two">
                                    <img src="assets/img/service/ser-icon8-2.svg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="service-img-eight-v1 two">
                                <a href="service-details.php" class="ext-box"></a>
                                <img src="assets/img/service/ser8-3.jpg" alt="">
                                <div class="service-content-eight-v1">
                                    <h6 class="title">Heart Checkup <br>or ardiovascular</h6>
                                </div>
                                <div class="ser-icons-two">
                                    <img src="assets/img/service/ser-icon8-3.svg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="service-img-eight-v1 three">
                                <a href="service-details.php" class="ext-box"></a>
                                <img src="assets/img/service/ser8-4.jpg" alt="">
                                <div class="service-content-eight-v1">
                                    <h6 class="title">Family Physician<br> & Doctor</h6>
                                </div>
                                <div class="ser-icons-two">
                                    <img src="assets/img/service/ser-icon8-4.svg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="service-img-eight-v1 four">
                                <a href="service-details.php" class="ext-box"></a>
                                <img src="assets/img/service/ser8-5.jpg" alt="">
                                <div class="service-content-eight-v1">
                                    <h6 class="title">Laboratory & <br>Pathology Drag</h6>
                                </div>
                                <div class="ser-icons-two">
                                    <img src="assets/img/service/ser-icon8-5.svg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="service-img-eight-v1 five">
                                <a href="service-details.php" class="ext-box"></a>
                                <img src="assets/img/service/ser8-6.jpg" alt="">
                                <div class="service-content-eight-v1">
                                    <h6 class="title">Hematology and<br> Super Cool</h6>
                                </div>
                                <div class="ser-icons-two">
                                    <img src="assets/img/service/ser-icon8-6.svg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 col-sm-12">
                    <div class="about-img-eight">
                        <img src="assets/img/about/ab-8-1.png" alt="">
                        <div class="exp-box-eight">
                            <div class="icon-box"><img src="assets/img/about/abicon1-1.svg" alt=""></div>
                ...
                <div class="col-lg-5 col-md-12 col-sm-12">
                    <div class="about-content-eight">
                        <p>There are many variations Lorem Ipsum availab.There are many of pas ofb.
                            There are many variations of by injected humour or randomised pas of Lorem 
                            Ipsum availab.There are many variations
                        </p>
                        <ul class="about-list-eight">
                            <li><i class="fa fa-plus"></i>Women's health services, including one-stop breast care centre</li>
                            <li><i class="fa fa-plus"></i>Internationally acclaimed consultants</li>
        ...
        <div class="container-style8">
            <div class="row">
                ...
                <div class="col-xl-5  col-md-6 col-sm-12">
                    <div class="skill-img">
                        <img src="assets/img/about/skill1-1.jpg" alt="">
                        <img src="assets/img/about/shape1-1.png" class="image" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="brand-slider text-center vs-carousel" data-slide-show="5" data-lg-slide-show="4" data-md-slide-show="3" data-sm-slide-show="2" data-xs-slide-show="1">
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-1.png" alt="image">
                </div>
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-2.png" alt="image">
                </div>
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-3.png" alt="image">
                </div>
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-5.png" alt="image">
                </div>
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-4.png" alt="image">
                </div>
                <div class="brand-img-six">
                    <img src="assets/img/brand/brand-6-1.png" alt="image">
                </div>
        ...
        <div class="container-style8">
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="team-card-ten">
                        <div class="team-img-ten">
                            <img src="assets/img/team/team8-1.jpg" alt="">
                        ...
                        <div class="info-box-ten">
                            <h4 class="name"><a href="#">Willimes Roman</a></h4>
                            <span class="designation">Outpatient Surgery</span>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="team-card-ten">
                        <div class="team-img-ten">
                            <img src="assets/img/team/team8-2.jpg" alt="">
                            <span class="share-icon-ten fa fa-share-alt"></span>
                            <div class="social-links-ten">
                                <a href="#"><i class="fab fa-instagram"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="info-box-ten">
                            <h4 class="name"><a href="#">Danial Frankie</a></h4>
                            <span class="designation">Outpatient Surgery</span>
                            <h4 class="number">+1 (212) 255-5511</h4>
                            <span class="date">Monday - Friday 08:00 — 18:00</span>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="team-card-ten">
                        <div class="team-img-ten">
                            <img src="assets/img/team/team8-3.jpg" alt="">
                            <span class="share-icon-ten fa fa-share-alt"></span>
                            <div class="social-links-ten">
                                <a href="#"><i class="fab fa-instagram"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="info-box-ten">
                            <h4 class="name"><a href="#">Qlark Romin</a></h4>
                            <span class="designation">Outpatient Surgery</span>
                            <h4 class="number">+1 (212) 255-5511</h4>
                            <span class="date">Monday - Friday 08:00 — 18:00</span>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 wow fadeInUp" data-wow-delay="400ms">
                    <div class="team-card-ten">
                        <div class="team-img-ten">
                            <img src="assets/img/team/team8-4.jpg" alt="">
                            <span class="share-icon-ten fa fa-share-alt"></span>
                            <div class="social-links-ten">
                                <a href="#"><i class="fab fa-instagram"></i></a>
                                <a href="#"><i class="fab fa-twitter"></i></a>
                        ...
                        <div class="info-box-ten">
                            <h4 class="name"><a href="#">Jessical Lower</a></h4>
                            <span class="designation">Outpatient Surgery</span>
                            <h4 class="number">+1 (212) 255-5511</h4>
                            <span class="date">Monday - Friday 08:00 — 18:00</span>
                        </div>
    ...
    <!-- review-section -->
    <section class="review-section space" data-bg-src="assets/img/bg/review-bg.jpg">  
        <div class="container-style8">
            <div class="row">
                <div class="col-xl-7 col-lg-12 col-md-12 col-sm-12">
                ...
                <div class="col-xl-5 col-lg-12 col-md-12 col-sm-12">
                    <div class="map-img">
                        <img src="assets/img/medicals/map.png" alt="">
                        <div class="location-img">
                            <img src="assets/img/medicals/location1-1.png" alt="">
                            <div class="map-popup">
                        ...
                        <div class="location-img-two">
                            <img src="assets/img/medicals/location1-2.png" alt="">
                            <div class="map-popup">
                                <h6 class="title">Medical Hospital</h6>
                                <span>800 Rose St. Fourth Floor Lexington, KY 40536</span>
                            </div>
                        ...
                        <div class="location-img-three">
                            <img src="assets/img/medicals/location1-3.png" alt="">
                            <div class="map-popup">
                                <h6 class="title">Medical Hospital</h6>
                                <span>800 Rose St. Fourth Floor Lexington, KY 40536</span>
                            </div>
                    ...
                    <div class="vs-blog blog-card-eight">
                        <div class="blog-img-eight">
                            ...
                            <div class="blog-meta-eight">
                                <a href="blog.php"><i class="fa fa-calendar"></i>January 2018</a>
                                <a href="blog.php"><i class="fa fa-comment"></i>Volume 01, Issue 01</a>
                            </div>
                        </div>
                        <div class="blog-content-eight">
                            <h3 class="blog-title h5 font-body lh-base"><a href="blog.php">An Official Publication of 
                ...
                <div class="col-xl-4 wow fadeInUp" data-wow-delay="500ms">
                    <div class="vs-blog blog-card-eight">
                        <div class="blog-img-eight">
                            ...
                            <div class="blog-meta-eight">
                                <a href="blog.php"><i class="fa fa-calendar"></i>February 28, 2023</a>
                                <a href="blog.php"><i class="fa fa-comment"></i>14</a>
                            </div>
                        </div>
                        <div class="blog-content-eight">
                            <h3 class="blog-title h5 font-body lh-base"><a href="blog.php">These blood markers may indicate a higher risk.</a></h3>
                            <p>Duis aute irure dolor in reprehe nderit in volu ptate velit esse a cilm.</p>
                            <a href="blog.php" class="review-btn-two wow fadeInUp animated">Read More</a>
                        </div>
                    </div>
                </div>
    ...
    <section class="contact-info-section-two">
        <div class="container-style8">
            <div class="outer-box" data-bg-src="assets/img/bg/blog-bg2-1.jpg">
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="contact-box-two">
                            <div class="icon-box"><img src="assets/img/blog/contact3-1.svg" alt=""></div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="contact-box-two">
                            <div class="icon-box"><img src="assets/img/blog/contact3-2.svg" alt=""></div>
                            <sub> Appointment</sub>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="contact-box-two">
                            <div class="icon-box"><img src="assets/img/blog/contact3-3.svg" alt=""></div>
                    ...
                    <div class="col-xl-4 col-lg-6  wow fadeInUp" data-wow-delay="400ms">
                        <div class="widget footer-widget">
                            <div class="vs-widget-about-eight">
                                <div class="footer-logo"><img src="assets/img/logo/Samorita-logoo.png" alt="logo"></div>
                                <p class="footer-text">Energistically reintermediate worldwide interfaces vis-a-vis emerging
                                    integrate leadership skills. worldwide interfaces vis-a-vis emerging integrate leadership
                                    skills.
                                </p>
                                
                                <ul class="footer-link-eight">
                                    <li><i class="fa fa-envelope"></i><a href="#">info@mhsamorita.edu.bd</a></li>
                                    <li><i class="fa fa-map-marker"></i>117, Love Road <br>
                                        Tejgaon, Dhaka-1208, Bangladesh.</li>
                                </ul>
                        ...
                        <div class="widget v2 footer-widget time">
                            ...
                            <div class="vs-widget-shedule">
                                <ul class="footer-shedule">
                                    <li class="one"><span>Mon - Fri:</span>8:00 am - 8:00 pm</li>
                                    <li><span>Saturday:</span>9:00 am - 6:00 pm</li>
                                    <li class="one"><span>Sunday:</span>9:00 am - 6:00 pm</li>
                                </ul>
                        ...
                        <div class="widget v2 footer-widget widget_nav_menu-eight">
                            ...
                            <div class="menu-all-pages-container-two">
                                ...
                                <ul class="menu-eight">
                                    ...
                                    <li><a href="#">Cleaning Scissor</a></li>
                                    <li><a href="#">Smart Mask</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from html.vecurosoft.com/medixi/demo/index-8.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 09:20:19 GMT -->
</html>