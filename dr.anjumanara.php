        ...
        <div class="row gx-40">
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Ms. Anjuman Ara Shimul</h2>
              <h3 class="text-theme fs-xs">Clinical Nutritionist & Diet Counselor<br> Department of Nutrition</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Ms. Anjuman Ara Shimul is a qualified clinical nutritionist with strong experience in dietary assessment, therapeutic nutrition and nutrition counseling. She works closely with patients and physicians to develop individualized diet plans that support recovery, manage chronic illness and promote long-term wellness. With a caring approach and evidence-based knowledge, she helps patients make realistic dietary changes for better health outcomes.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  <tr>
                    ...
                    <td>Clinical Nutrition & Diet Therapy</td>
                  </tr>
                  <tr>
                    <th><strong>Degrees</strong></th>
                    <td>
                      <ul class="member-info-list">
                        <li>BSC (Food and Nutrition).</li>
                        <li>MSC(Nutrition).</li>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        <li>Medical nutrition therapy for diabetes, hypertension and kidney disease</li>
                        <li>Weight management and obesity treatment</li>
                        <li>Nutritional counseling for pregnancy and lactation</li>
                        <li>Gastrointestinal disorders and food intolerances</li>
                        <li>Malnutrition, anemia and vitamin deficiencies</li>
                        <li>Child nutrition and growth monitoring</li>
                        <li>Post-surgical diet planning</li>
                        <li>Cancer and liver disease diet support</li>
                        <li>Diet plans for lifestyle diseases and general wellness</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>BSc in Food & Nutrition and MSc in Nutrition from the University of Dhaka, with additional training in clinical dietetics and patient counseling.</td>
                  </tr>
                </tbody>
              </table>
              <form
