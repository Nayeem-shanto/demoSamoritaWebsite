          ...
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}" >BMDC Registration Number : A- 29388 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              ...
              <div style="text-align: justify;">
                ...
                Dr. Ahmed Mostofa Zaman is a promising and dedicated cardiologist with growing expertise in the management of heart diseases. As an Assistant Professor (Contractual Category) in the Department of Cardiology at MH Samorita Hospital & Medical College, he plays a vital role in both clinical services and academic activities. He is committed to providing evidence-based care and has a strong interest in non-invasive cardiology and preventive heart health.
              </p>
              <p class="fs-md text-title">
                He completed his MBBS from a reputed institution in Bangladesh, followed by a Diploma in Cardiology (D-CARD) and later obtained his MD in Cardiology from Bangladesh Medical University (BMU). Dr. Zaman is actively involved in teaching, ward supervision and patient consultations.
              </p>
              </div>
              <table class="member-table" >
                <tbody style="background-color: #f3f6f7;">
                  ...
                  <tr>
                    ...
                    <td>He completed his MBBS from a reputed institution in Bangladesh, followed by a Diploma in Cardiology (D-CARD) and later obtained his MD in Cardiology from Bangladesh Medical University (BMU).</td>
                  </tr>
                </tbody>
              </table>
              <form
