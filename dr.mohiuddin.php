        ...
        <div class="row gx-40">
            ...
            <div class="col-lg-7">
                <div class="team-content">
                    <h2 class="mb-0 mt-n2">Dr. Mohiuddin Ahmed</h2>
                    <p class="text-theme fs-xs">MBBS, FCPS (Anesthesiology)<br><br> Senior Consultant<br>Department of Anesthesiology</p>
                    <div style="text-align: justify;">
                        <p class="fs-md text-title">
                            <strong>Dr. Mohiuddin Ahmed</strong> is a highly experienced anesthesiologist with over three decades of dedicated service as an anesthesiologist in all discipline of Surgery including Cardiac Surgery both routine & emergency. As a Senior Consultant in the Department of Anesthesiology at MH Samorita Hospital & Medical College, he is known for his leadership in the operating room and expert handling of high-risk patients. He ensures patient safety and comfort across a wide range of procedures and is also involved in mentoring junior colleagues and guiding clinical protocols. He also worked in ICU of this hospital.
                        </p>
                    </div>
                    <table class="member-table">
                        <tbody style="background-color: #f3f6f7;">
                            <tr>
                                ...
                                <td> Anesthesiology and Critical Care</td>
                            </tr>
                            <tr>
                                <th><strong>Degrees</strong></th>
                                <td>
                                    <ul class="member-info-list">
                                        <li>MBBS – Chittagong Medical College, University of Chittagong</li>
                                        <li>FCPS (Anesthesiology) – Bangladesh College of Physicians & Surgeons (BCPS)</li>
                                        <li>WHO Fellow in Cardiac Anesthesia – Fortis Hospital, Delhi</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        <li>General, spinal and epidural anesthesia</li>
                                        <li>Anesthesia for cardiac, trauma and abdominal surgeries</li>
                                        <li>Pain management and postoperative recovery</li>
                                        <li>Critical care and ventilator management</li>
                                        <li>Pediatric and elderly patient anesthesia</li>
                                        <li>Emergency resuscitation and airway control</li>
                                        <li>Monitoring complex surgical cases</li>
                                        <li>Infection prevention and patient safety protocols</li>
                                    </ul>
                                </td>
                            </tr>
                        </tbody>
