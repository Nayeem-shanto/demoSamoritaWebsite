...
<!-- Mirrored from html.vecurosoft.com/medixi/demo/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 09:15:59 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>MH Samorita Medical College and Hospital</title>
...
============================== -->
                ...
                <div class="row justify-content-center justify-content-xl-between">
                    <div class="col-auto">
                        <ul class="header-top-info list-unstyled m-0">
                            <li><i class="far fa-envelope"></i><a href="#" class="text-reset">info@mhsamorita.com</a></li>
                            <li><i class="far fa-map-marker-alt"></i>117 Love Rd ,Tejgaon, Dhaka 1208, Bangladesh</li>
                            <li><i class="far fa-clock"></i>Everyday: 24/7</li>
                        </ul>
                    </div>
    ...
    <div data-bg-src="assets/img/bg/etbghgetg-01.jpg">
        <!--==============================
    Testimonial Area
    ==============================--><br><br><br><br>
                ...
                <div class="row  text-center justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="section-title">
                            <img style="width:220px; height: 220px;" src="assets/img/Logo-01.png" alt="Logo">
                        </div>
                    </div>
                </div>
                <div  class="row">
                <div class="col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="400ms">
                    <div class="service-card6">
                        <!--<div class="icon-box">
                            <i class="fa fa-heart"></i>
                        </div>-->
                    
                        <a href="index-4.php" style="text-decoration: none;">
                    <div class="content-box" style="cursor: pointer;">
                         <h4 style="color:white;" class="title">Hospital</h4>
                        <p style="color:white;">"Healing Hands, Caring Hearts."</p>
                        <span class="more-btn"><i class="fa fa-arrow-right"></i></span>
                    </div>
                        </a>

                    </div>
                </div>
                <div class="col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="500ms">
                    <div class="service-card6">
                        <!--<div class="icon-box">
                            <i class="fa fa-swords"></i>
                        </div>-->
                    
                        <a href="index-8.php" style="text-decoration: none;">
                    <div class="content-box" style="cursor: pointer;">
                         <h4 style="color:white;" class="title">Medical College</h4>
                        <p style="color:white;">"Training Healers, Transforming Lives."</p>
                        <span class="more-btn"><i class="fa fa-arrow-right"></i></span>
                    </div>
                        </a>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between">
                    <div class="col-auto text-center text-md-end">
                        <p class="mb-0 text-white">Copyright <i class="fal fa-copyright"></i> 2025. Planet Information Technology Solutions Limited. All rights reserved.</a>.</p>
                    </div>
...
<!-- Mirrored from html.vecurosoft.com/medixi/demo/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 19 Jan 2025 09:16:38 GMT -->
</html>