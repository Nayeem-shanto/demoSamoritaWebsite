      ...
      <div class="col-lg-5">
        <div
          ...
          <div class="member-details-img">
            ...
            <img
              src="./assets/img/doctorImage/medicine/drSekenderAli.JPG"
              alt="Member Image"
              class="w-100" />
          </div>
          ...
          <a href="https://verify.bmdc.org.bd/" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-20310 </span><i
              ...
              <tr>
                ...
                <td>
                  <ul class="member-info-list">
                    ...
                    <li>Infectious diseases (e.g., dengue, TB, typhoid, HIV)</li>
