        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              <div class="member-details-img">
                ...
                <img
                  src="assets/img/team/sekenderali.png"
                  alt="Member Image"
                  class="w-100"
                />
              </div>
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-20310</span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Md. Sekender Ali</h2>
              <h3 class="text-theme fs-xs">Associate Professor<br> Department of Medicine</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Md. Sekendar Ali is an experienced and well-respected physician in the field of Internal Medicine, with over 20 years of clinical and academic experience. He is known for his detailed diagnostic skills, clinical judgment and kind bedside manner. Dr. Ali has been serving as a core faculty member at MH Samorita Hospital & Medical College, where he combines his teaching responsibilities with compassionate patient care.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               He earned his MBBS from Rajshahi Medical College, followed by FCPS in Medicine from the Bangladesh College of Physicians and Surgeons (BCPS). Currently, he is an Associate Professor in the Department of Medicine and plays a key role in clinical teaching, undergraduate training and postgraduate mentoring.
              </p>
              ...
              <table class="member-table" style="background-color: #f3f6f7;">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                            ...
                            <li>Infectious diseases (e.g., dengue, TB, typhoid)</li>
                            <li>Gastrointestinal and liver disorders</li>
                            <li>Respiratory illnesses (asthma, COPD, pneumonia)</li>
                            <li>Kidney diseases and electrolyte imbalance</li>
                            <li>Neurological disorders (e.g., stroke, seizures)</li>
                            <li>Rheumatologic conditions</li>
                            <li>Geriatric medicine and chronic disease management</li>
                  ...
                  <tr>
                    ...
                    <td>MBBS from Rajshahi Medical College, followed by FCPS in Medicine from the Bangladesh College of Physicians and Surgeons (BCPS).
                  </tr>
                </tbody>
              </table>
              <form
