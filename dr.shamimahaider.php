        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A- 20165 </span>
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Shamima Haider</h2>
              <p class="text-theme fs-xs">Assistant Professor (CC) <br>Department of Gynaecology & Obstetrics</p>
              <p class="fs-md text-title" style="text-align: justify;">
                Assistant Professor Dr. Shamima Haider is a distinguished Obstetrician and Gynaecologist 
