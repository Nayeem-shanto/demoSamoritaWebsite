...
<div class="breadcumb-wrapper">
    ...
    <div class="container z-index-common">
        <div class="breadcumb-content">
            <h1 class="breadcumb-title">Department of Surgery</h1>
        ...
        <div class="row gx-40">
            <div class="col-lg-5">
                ...
                <a href="#"><i class="fab fa-linkedin-in"></i></a> -->
                    ...
                    <a href="https://verify.bmdc.org.bd/" class="certifate-link"><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A- 34055 </span>
            ...
            <div class="col-lg-7">
                <div class="team-content">
                    <h2 class="mb-0 mt-n2">Asst. Prof. Dr. Zamal Uddin</h2>
                    <p class="text-theme fs-xs">MBBS, FCPS (Surgery) <br><br> Assistant Professor<br>Department of Surgery</p>
                    <div style="text-align: justify;">
                        <p class="fs-md text-title">
                            <strong>Asst. Prof. Dr. Zamal Uddin</strong> is a committed general surgeon currently serving as Assistant Professor in the Department of Surgery at MH Samorita Hospital & Medical College. He is actively engaged in both academic responsibilities and surgical patient care. Dr. Zamal is known for his surgical precision, sound clinical judgment and focus on safe and effective treatment outcomes. He is experienced in handling a wide range of general and emergency surgical cases with a structured, patient-centered approach.
                        </p>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        <li>MBBS – M. Abdur Rahim Medical Collge,Dinajpur, University of Rajshahi</li>
                                        <li>FCPS (Surgery) – Bangladesh College of Physicians & Surgeons (BCPS)</li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="member-info-list">
                                        ...
                                        <li>Gallbladder and appendix surgery</li>
                                        <li>Hernia surgery</li>
                                        <li>Gastrointestinal and colorectal surgery</li>
                                        <li>Breast surgery</li>
                                        <li>Minor and emergency surgical care</li>
                                        <li>Trauma surgery</li>
                                        <li>Post-operative follow-up and care</li>
                                        <li>Colorectal, Laser, Longo – Surgery</li>
                                    </ul>
                                </td>
                            </tr>
                        </tbody>
