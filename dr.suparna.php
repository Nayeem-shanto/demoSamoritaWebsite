        ...
        <div class="row gx-40">
          <div class="col-lg-5">
            ...
            >
              ...
              <a href="https://verify.bmdc.org.bd/" class="certifate-link"
                ><span style="color: #07ccec; :hover {color: #FFFFFF;}">BMDC Registration Number: A-44677 </span><i
          ...
          <div class="col-lg-7">
            <div class="team-content">
              <h2 class="mb-0 mt-n2">Dr. Suparna Chowdhury</h2>
              <h3 class="text-theme fs-xs">Registrar<br> Department of Gynaecology & Obstetrics</h3>
              <p class="fs-md text-title" style="text-align: justify;">
                Dr. Suporna Chowdhury is a promising and committed Obstetrician and Gynaecologist with several years of hands-on clinical experience in women's reproductive healthcare. Known for her calm demeanor and patient-focused care, she manages both routine and emergency gynecological cases with precision and empathy.
              </p>
              <p class="fs-md text-title" style="text-align: justify;">
               She completed her MBBS from Shaheed Suhrawardy Medical College, and later achieved FCPS in Obstetrics and Gynaecology from the Bangladesh College of Physicians and Surgeons (BCPS). Dr. Chowdhury currently serves as a Registrar in the Department of Obstetrics & Gynaecology at MH Samorita Hospital & Medical College, where she is actively involved in patient care, emergency response, and medical ward management.
              </p>
                  ...
                  <tr>
                    ...
                    <td>
                      <ul class="member-info-list">
                        ...
                        <li>Infertility support and counseling</li>
                        <li>Menstrual irregularities</li>
                        <li>Contraception and family planning</li>
                        <li>Cesarean and normal delivery assistance</li>
                        <li>Minor and emergency gynecologic procedures</li>
                        <li>Postpartum complications management</li>
                      </ul>
                    </td>
                  </tr>
                  <tr>
                    <th><strong>Academic Qualification</strong></th>
                    <td>MBBS from Shaheed Suhrawardy Medical College,  FCPS in Obstetrics and Gynaecology from the Bangladesh College of Physicians and Surgeons (BCPS).</td>
                  </tr>
                </tbody>
              </table>
              <form
